    ...
    <main class="main-window">
        <div class="main-container-window">
            <div class="title-clients">
                <h3>Brands</h3>
                <img onclick="location.href = 'brands-new.php'" class="add" src="assets/icon/add_cat.png">
            </div>
            <div class="content-clients">
                <table class="table">
                    ...
                    <thead>
                        <th class="table-head">Id Marca</th>
                            ...
                            if($Result = $Connectdb->query($Query)){
                                while($Reg = $Result->fetch_assoc()){
                                    $Tmp = '<tr class="table-row">';
                                        $Tmp .= '<td class="table-data">'.$Reg['id_marca'].'</td>';
                                        $Tmp .= '<td class="table-data">'.$Reg['marca'].'</td>';
                                        $Tmp .= '<td class="table-data"><a href="brands-edit.php?Marid='.$Reg['id_marca'].'">';
                                        $Tmp .= '<img src="assets/icon/edit.png" class="img-data"></a></td>';
                                        $Tmp .= '<td class="table-data"><a href="brands-delete.php?Marid='.$Reg['id_marca'].'">';
