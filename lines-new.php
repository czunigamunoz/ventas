...
<head>
    ...
    <title>The Wood Knot - Lines - Add</title>
</head>
    ...
    <main class="main-window">
        <div class="main-container-window">
            ...
            <div class="content-clients">
                <form class="form" action="lines-add.php" method="POST">
                    <div class="form-input">
                        <label for="idLine" class="label">Id Linea: </label>
                        <input class="input" type="text" name="idLine" disabled>
                    </div>

                    <div class="form-input">
                        <label for="Linep" class="label">Linea: </label>
                        <input class="input" type="text" name="Linep" required>
                    </div>
