...
<head>
    ...
    <title>The Wood Knot - Clients - Add</title>
</head>
    ...
    <main class="main-window">
        <div class="main-container-window">
            <div class="title-clients">
                <h3>Types of Clients - Add</h3>
                <img class="img-ico" src="assets/icon/user_add.png">
            </div>
            <div class="content-clients">
                <form class="form" action="client-add.php" method="POST">
                    <div class="form-input">
                        <label for="idTipo" class="label">Id Tipo: </label>
                        <input class="input" type="text" name="idTipo" disabled>
                    </div>

                    <div class="form-input">
                        <label for="Tipoc" class="label">Tipo: </label>
                        <input class="input" type="text" name="Tipoc" required>
                    </div>
