    ...
    <main class="main-window">
        <div class="main-container-window">
            <div class="title-clients">
                <h3>Categories</h3>
                <img onclick="location.href = 'categories-new.php'" class="add" src="assets/icon/add_cat.png">
            </div>
            <div class="content-clients">
                <table class="table">
                    ...
                    <thead>
                        <th class="table-head">Id Categoria</th>
                            ...
                            if($Result = $Connectdb->query($Query)){
                                while($Reg = $Result->fetch_assoc()){
                                    $Tmp = '<tr class="table-row">';
                                        $Tmp .= '<td class="table-data">'.$Reg['id_categoria'].'</td>';
                                        $Tmp .= '<td class="table-data">'.$Reg['categoria'].'</td>';
                                        $Tmp .= '<td class="table-data"><a href="categories-edit.php?Cateid='.$Reg['id_categoria'].'">';
                                        $Tmp .= '<img src="assets/icon/edit.png" class="img-data"></a></td>';
                                        $Tmp .= '<td class="table-data"><a href="categories-delete.php?Cateid='.$Reg['id_categoria'].'">';
